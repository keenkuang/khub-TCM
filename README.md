...
- **患者数字孪生体管理系统**（规划中）：以患者为中心聚合病历子系统、问诊子系统及未来子系统。
- **门诊运营管理系统**（规划中）：排班 / 预约 / 就诊流。
- **中医考试培训系统**（规划中）：题库 + RAG 出题 / 判分。
...
python3 -m pytest -q               # 跑全部测试（26 个，无需联网）
```
